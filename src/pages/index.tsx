...
const Home = () => {
  ...
  return (
    <>
      <MetaTags
        title="Traddy Yours Travel Advisor"
        description="Developed a fully-responsive travel advisor application, built using Next.js and TypeScript combining
         Google Maps API, Travel Advisor API and WeatherAPI.com which can be used to search for places, hotels, restaurants and attractions based on the current location or location that we search for."
        url=""
        image="/Logo.png"
      />
